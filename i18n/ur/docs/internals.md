...
??? example "ان میں سے نو ایڈیشن، صورتوں کی ترتیب میں"
...
سے CPython 3.14.6 اور macOS 26 پر ایک arm64 لیپ ٹاپ پر ناپا گیا: ایک فیلڈ
والے پیغام کے لیے تقریباً 0.4 µs، جس میں خود t-string کی تعمیر بھی شامل ہے،
یعنی اُس سادہ `gettext(...).format(...)` کا تقریباً ‏2.7 گنا جو کچھ بھی نہیں
جانچتا۔ یہ ایک ہی مشین کے اعداد ہیں — سکرپٹ اپنے ہیڈر میں اپنا مفسر اور
پلیٹ فارم چھاپتا ہے، لہٰذا کسی بھی تناسب کو اپنا سمجھنے سے پہلے اسے اُسی
ہارڈویئر پر چلائیے جس پر آپ واقعی تعیناتی کرتے ہیں۔
...
اوپر کی کوئی بات اسی نفاذ کے ساتھ خاص نہیں: اصول [تصریح v1](spec.md) کی صورت میں لکھا ہوا
