...
## طے شدہ طور پر مضبوط { #robust-by-default }

ایک خراب فائل پورا چکر ختم نہیں کرتی:
...
نقشے کے اختیارات میں `strict = true` رکھ دیجیے تو ان میں سے ہر ایک سخت ناکامی
بن جاتی ہے، اور CI میں آپ یہی چاہتے ہیں۔
...
ان کا رویہ ان کا اپنا ہے؛ نیچے دیے گئے دو اوزار وہ ہیں جن کی یہاں تصدیق کی
گئی ہے۔
...
دونوں جانچیں فالتو نہیں ہیں۔ ساتھ آنے والا چیکر کم از کم دو جگہوں پر زیادہ
سخت فریق ہے:
