...
Что может пойти не так: повреждённая подстановка оборачивается исключением во
время выполнения, если только проверка каталога не поймает её раньше.
...
Как Python пришёл к этому — две PEP с разницей в десять лет и
