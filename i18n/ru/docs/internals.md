...
??? example "Девять из этих изданий, в порядке форм"
...
[Таблица чтения ошибок](translators.md#reading-a-failure-message), написанная
...
Ничто из вышесказанного не специфично для этой реализации: соглашение записано как
