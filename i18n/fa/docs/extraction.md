...
## به‌طور پیش‌فرض مقاوم { #robust-by-default }

یک فایل بد اجرای کار را پایان نمی‌دهد:
...
با گذاشتن `strict = true` در گزینه‌های نگاشت، هر یک از این‌ها به شکست
سخت تبدیل می‌شود — همان که در CI می‌خواهید.
...
کرده‌اند. رفتار آن‌ها با خودشان است؛ دو ابزار پایین همان‌هایی‌اند که
...
آن دو بررسی زائد بر هم نیستند. بررسی‌کنندهٔ همراه دست‌کم در دو جا طرفِ
سخت‌گیرتر است:
