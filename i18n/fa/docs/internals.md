...
آکولاد.
[جدول خواندن شکست در راهنما](guide.md#reading-a-failure-message) هر یک
از این پیام‌ها را عیناً نشان می‌دهد.
...
اندازه گرفته است: حدود ۰٫۴ میکروثانیه برای پیامی تک‌فیلدی، شاملِ ساختِ
خودِ t-string، تقریباً ۲٫۵ برابرِ یک `gettext(...).format(...)`ِ ساده که
هیچ‌چیز را بررسی نمی‌کند. یادداشت بالای
[`core.py`](https://github.com/yhay81/gettext-tstrings/blob/main/src/gettext_tstrings/core.py)
اندازه‌گیری‌های تک‌تکِ پشت این تصویر را ثبت کرده است.

## پیاده‌کردن دوبارهٔ آن { #reimplementing-it }

هیچ‌یک از آنچه گفته شد دانشی نهان نیست: قرارداد به‌صورت
