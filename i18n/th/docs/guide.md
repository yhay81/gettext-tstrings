...
!!! warning "เธรดทำงานเริ่มต้นโดยยังไม่ถูกผูก"

    `threading.Thread` เปล่า ๆ หรือ `ThreadPoolExecutor.submit`
    เริ่มต้นด้วยคอนเท็กซ์ใหม่เอี่ยม และไม่สืบทอดการผูกมาด้วย —
    การเรียกจึงถอยกลับไปใช้แคตตาล็อก gettext ที่เป็น global ของโปรเซส
    ให้พาคอนเท็กซ์ติดไปด้วยอย่างชัดเจน:
