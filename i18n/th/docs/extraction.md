...
## ทนทานโดยค่าเริ่มต้น { #robust-by-default }

ไฟล์เสียหนึ่งไฟล์ไม่ทำให้การรันทั้งหมดจบลง
...
ตั้ง `strict = true` ในตัวเลือกของ mapping เพื่อเปลี่ยนทุกกรณีข้างต้น
ให้เป็นความล้มเหลวแบบเด็ดขาดแทน ซึ่งคือสิ่งที่คุณต้องการใน CI
...
การตรวจทั้งสองไม่ซ้ำซ้อนกัน ตัวตรวจที่มาพร้อมแพ็กเกจเป็นฝ่ายที่เข้มงวดกว่า
อย่างน้อยสองจุด
