---
description: "एक ही अनुवाद-योग्य संदेश %-format, .format(), flufl.i18n के $-strings और t-string से लिखा हुआ — अनुवादक की ग़लतियों, कैटलॉग के अधिकार और एकीकरण की क़ीमत पर तुलना।"
---

# t-strings क्यों

एक अनुवाद-योग्य संदेश में value रखने के चार तरीक़े, एक ही संदेश पर तुलना किए
हुए। चारों अपने placeholders को नाम देते हैं और अनुवादक को उनका क्रम बदलने
देते हैं; फ़र्क़ इसमें है कि अनुवाद ग़लत होने पर क्या होता है, कैटलॉग आपके
प्रोग्राम के कितने हिस्से तक पहुँच सकता है, और उन्हें अपनाने की क़ीमत क्या है।

तालिकाएँ पहले आती हैं, ताकि आप अपने काम की पंक्ति ढूँढ़कर सिर्फ़ उसके पीछे
वाला भाग पढ़ सकें।
...
**जब अनुवादक से कोई ग़लती हो जाए।** कैटलॉग कई हाथों से होकर गुज़रता है, और
उसमें जो ग़लत होता है उसका अधिकांश अनजाने में होता है:

| | `%(name)s` | `.format()` | `flufl.i18n` `$name` | `t"…"` |
| --- | --- | --- | --- | --- |
| अनुवाद कोई placeholder *छोड़ दे* — क्या रेंडर होता है? | value चुपचाप ग़ायब हो जाती है | value चुपचाप ग़ायब हो जाती है | value चुपचाप ग़ायब हो जाती है | स्रोत संदेश, एक चेतावनी के साथ ([डिफ़ॉल्ट रूप से](guide.md#what-happens-when-a-catalog-is-wrong)) |
| अनुवाद कोई अज्ञात placeholder *जोड़ दे* — क्या रेंडर होता है? | एक exception | एक exception | placeholder टेक्स्ट के रूप में दिखता रहता है | स्रोत संदेश, एक चेतावनी के साथ ([डिफ़ॉल्ट रूप से](guide.md#what-happens-when-a-catalog-is-wrong)) |
| अनुवाद किसी placeholder की *फ़ॉर्मैटिंग बदल दे* — क्या रेंडर होता है? | जो कैटलॉग ने माँगा, या exception यदि type-अक्षर अब value पर फ़िट नहीं बैठता | जो कैटलॉग ने माँगा | `$`-strings में यह कहा ही नहीं जा सकता | स्रोत संदेश, एक चेतावनी के साथ |
| क्या रेंडर के समय placeholders की जाँच होती है? | नहीं | नहीं | नहीं | हाँ (नीचे देखें) |

**कैटलॉग के पास कितना अधिकार है।** अनुवाद आपके रिपॉज़िटरी के बाहर से आया डेटा
है, और हर शैली उसे अलग-अलग मात्रा में शक्ति सौंपती है:
...
**एकीकरण की क़ीमत क्या है।** ऊपर का सब कुछ मुफ़्त है — बशर्ते टूलिंग फ़िट
बैठे; यहीं वह जगह है जहाँ शायद न बैठे:

| | `%(name)s` | `.format()` | `flufl.i18n` `$name` | `t"…"` |
| --- | --- | --- | --- | --- |
| न्यूनतम Python | कोई भी | कोई भी | 3.10 | **3.14** |
| परिपक्वता | मानक लाइब्रेरी | मानक लाइब्रेरी | स्थिर रिलीज़ | **alpha** |
...
## संगतता और परिपक्वता { #compatibility-and-maturity }

पिछली तालिका की पहली दो पंक्तियाँ ही अपनाने का निर्णय तय करती हैं, इसलिए
उन्हें खानों में छिपाने की बजाय साफ़-साफ़ कह देना बेहतर है।

`%`-format और `.format()` Python में अंतर्निहित हैं और उन्हें किसी निर्भरता की
ज़रूरत ही नहीं। [`flufl.i18n`][flufl-i18n] एक परिपक्व पैकेज है, जो रिलीज़ हो
चुका है और प्रोडक्शन में उपयोग होता है, तथा Python 3.10 और बाद पर चलता है।
`gettext-tstrings` एक **alpha** है और उसे **Python 3.14 या नया** चाहिए,
क्योंकि t-strings 3.14 का नया सिंटैक्स हैं — कोई back-port नहीं है और हो भी
नहीं सकता। इसका [विनिर्देश](spec.md) ही इसका स्थिर हिस्सा है; Python API 1.0
से पहले अभी बदल सकती है।

जो क़ीमत इनमें से कोई नहीं माँगता, वह है कैटलॉग संगतता। चारों साधारण POT/PO/MO
फ़ाइलें बनाते हैं जिन्हें हर PO एडिटर, अनुवाद प्लेटफ़ॉर्म और GNU gettext टूल
पहले से पढ़ लेता है, इसलिए नीचे का चुनाव उस तरह पलटा जा सकता है जैसे कैटलॉग का
*फ़ॉर्मैट* बदलने पर कभी नहीं पलटा जा सकता। मौजूदा प्रोजेक्ट को ले जाने की बात
[माइग्रेशन](migration.md) पर है।

नीचे के भाग हर समझौते को विस्तार से दिखाते हैं, एक-एक तरीक़ा करके।
...
क्या ग़लत हो सकता है: क्षतिग्रस्त प्लेसहोल्डर रनटाइम exception बन जाता है,
बशर्ते कैटलॉग सत्यापन उसे पहले न पकड़ ले।
...
PO एडिटर में एक-अक्षर का संपादन रनटाइम exception बन जाता है, बशर्ते कैटलॉग
सत्यापन उसे पहले न पकड़ ले। GNU `msgfmt --check-format` इसे पकड़ तो लेता है, पर
केवल `python-format` फ़्लैग वाले संदेशों के लिए, और तभी जब कैटलॉग आपके
एप्लिकेशन तक पहुँचने से पहले वास्तव में msgfmt से होकर गुज़रे।
...
के प्रतिस्थापन namespace का हिस्सा बन जाता है। यहाँ की तुलना `flufl.i18n`
...
है और स्रोत संदेश रेंडर करती है, इसलिए ख़राब कैटलॉग एप्लिकेशन को कभी नहीं
गिराता —
...
किसी अनुवादक को उसे देखना नहीं पड़ता। पर वह एक *निश्चित* फ़ॉर्मैट है,
स्थानीयकृत नहीं — प्रति भाषा अंक और विभाजक चुनना
[Babel का काम है, कॉल से पहले](guide.md#locale-aware-values)।
...
## इस प्रतिबंध की क़ीमत { #the-cost-of-the-restriction }

Python की अनिवार्यता के अलावा इस सबकी क़ीमत एक ही नियम है: इंटरपोलेशन को सादा
नाम होना ही होगा।
...
यह एक वास्तविक बाधा है, और यही वह बाधा है जो ऊपर की गारंटियाँ पैदा करती है।
स्रोत-पक्ष value binding और रनटाइम placeholder जाँच के साथ मिलकर यह कैटलॉग
स्ट्रिंग्स को एक्सप्रेशन का मूल्यांकन करने से रोकती है और placeholder नामों
को उस व्यक्ति के लिए अर्थपूर्ण रखती है जो उनका अनुवाद कर रहा है।
...
Python यहाँ तक कैसे पहुँचा — दस साल के अंतराल पर दो PEP, और stdlib की
