...
जापानी इस पेज का उदाहरण-लक्ष्य है, पर इस चुनाव पर कुछ निर्भर नहीं करता। कोई
दूसरी भाषा उपयोग करनी हो तो चरण 4 में `ja` बदल दें — वह locale कोड ही
एकमात्र चीज़ है जो उसका नाम लेती है।
...
अनुवादक आम तौर पर सोर्स कोड से नहीं, कैटलॉग से काम करते हैं, इसलिए आपके और
उनके बीच **कैटलॉग** नाम की एक छोटी फ़ाइल आती-जाती है। उसकी ओर पहला क़दम है
कोड में मार्क किए हर संदेश को इकट्ठा करना।
...
एक बात अभी जान लेना ठीक रहेगा: यह त्रुटि रिपोर्ट करती है और non-zero exit
करती है, पर `.mo` फिर भी लिख देती है। असली प्रोजेक्ट में उस exit status पर
रुकना CI का काम है — [प्रोडक्शन में](workflow.md#what-ci-gates) वही सेट करता
है।

## 5. चलाएँ { #5-run-it }

चरण 2–4 में `tr()` का उपयोग हुआ, जो कैटलॉग ढूँढ़ता है और कोई नहीं पाता। अब
जब एक मौजूद है, उसे लोड करके एक बार बाँध दें: `Translator` कैटलॉग को थामे
रखता है ताकि कॉल स्थलों को उसका नाम न लेना पड़े, और `_` परिणाम के लिए
पारंपरिक gettext नाम है।
...
1. मानक लाइब्रेरी कंपाइल किए गए `.mo` को लोड करती है, और `Translator` उसे
   ...
   पर आता है। यह वही अनुवाद करता है जो `tr` करता है, बस एक कैटलॉग से बँधा
   हुआ।
...
- [माइग्रेशन](migration.md) — अगर जिस प्रोजेक्ट में आप यह सचमुच करना चाहते
  हैं उसमें पहले से gettext कैटलॉग हैं।
- [अनुवादकों के लिए](translators.md) — जो व्यक्ति उन `msgstr` पंक्तियों को
  भरता है, उसे थमाने के लिए एकमात्र पेज।
