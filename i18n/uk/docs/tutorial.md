...
підставте будь-яку мову на кроці 4, де код локалі `ja` — єдине місце, що її
називає.
...
Перекладачі не читають ваш вихідний код; між вами й ними подорожує невеликий
файл — **каталог**. Перший крок до нього — зібрати з коду всі позначені
повідомлення.
...
1. Стандартна бібліотека завантажує скомпільований `.mo`, а `Translator`
   ...
   бачить користувач. Це та сама функція, що й `tr`, прив'язана до одного
   каталогу.
