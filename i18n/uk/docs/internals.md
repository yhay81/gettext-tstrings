...
??? example "Дев'ять із тих видань, у порядку форм"
...
на CPython 3.14.6, macOS 26 на ноутбуці з arm64: приблизно 0,4 мкс на
повідомлення з одним полем, включно з побудовою самого t-рядка, — близько
2,7× від голого `gettext(...).format(...)`, що не перевіряє нічого. Це числа
однієї машини — скрипт друкує свій інтерпретатор і платформу у заголовку,
тож запустіть його на тому залізі, куди ви справді розгортаєтеся, перш ніж
вважати якесь співвідношення своїм. Коментар угорі
[`core.py`](https://github.com/yhay81/gettext-tstrings/blob/main/src/gettext_tstrings/core.py)
фіксує окремі вимірювання за цією формою.

## Реалізувати самостійно { #reimplementing-it }

Ніщо з наведеного не є специфічним для цієї реалізації: угода записана як
