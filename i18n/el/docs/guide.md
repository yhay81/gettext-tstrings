...
!!! warning "Ένα νήμα εργασίας ξεκινά αδέσμευτο"

    Ένα γυμνό `threading.Thread`, ή η `ThreadPoolExecutor.submit`, ξεκινά με
    φρέσκο συγκείμενο και δεν κληρονομεί το δέσιμο — η κλήση υποχωρεί στον
    καθολικό για τη διεργασία κατάλογο gettext. Μεταφέρετε το συγκείμενο
    ρητά:
