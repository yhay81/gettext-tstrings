...
??? example "Εννέα από αυτές τις εκδόσεις, με τη σειρά των μορφών"
...
[πίνακας ανάγνωσης αποτυχιών](translators.md#reading-a-failure-message) που
γράφτηκε για τους μεταφραστές δείχνει καθένα από αυτά τα μηνύματα αυτολεξεί.
...
σε CPython 3.14.6, macOS 26 σε φορητό υπολογιστή arm64: περίπου 0,4 µs για ένα
μήνυμα ενός πεδίου, συμπεριλαμβανομένης της κατασκευής του ίδιου του t-string,
περίπου 2,7× ένα σκέτο `gettext(...).format(...)` που δεν ελέγχει τίποτα.
Αυτοί είναι οι αριθμοί ενός μηχανήματος — το σενάριο τυπώνει τον διερμηνέα και
την πλατφόρμα του στην κεφαλίδα του, οπότε τρέξτε το στο υλικό όπου πράγματι
αναπτύσσετε προτού θεωρήσετε δικό σας οποιονδήποτε λόγο. Ο σχολιασμός στην
κορυφή του
...
Τίποτα από τα παραπάνω δεν είναι ειδικό για αυτή την υλοποίηση: η σύμβαση είναι
