...
!!! warning "Το `-c` δεν είναι προαιρετικό"
...
## Εύρωστο από προεπιλογή { #robust-by-default }

Ένα κακό αρχείο δεν τερματίζει την εκτέλεση:
...
Ορίστε `strict = true` στις επιλογές της αντιστοίχισης για να μετατρέψετε
καθένα από αυτά σε σκληρή αποτυχία, που είναι αυτό που θέλετε στο CI.
...
τους είναι δική τους ευθύνη· τα δύο εργαλεία παρακάτω είναι αυτά που έχουν
επαληθευτεί εδώ.
...
Οι δύο έλεγχοι δεν είναι πλεονασμός. Ο ελεγκτής που συνοδεύει το πακέτο
είναι ο αυστηρότερος από τους δύο σε τουλάχιστον δύο σημεία:
