...
অনুবাদকদের কাছে, আর `.po` ফাইলগুলি অনুবাদ *ফিরিয়ে* আনে। নিচের সবটাই এই দুইয়ের
মধ্যের যাতায়াত।
...
টিউটোরিয়ালের `pybabel init` প্রতি ভাষায় সারাজীবনে একবারই চলে। তারপর থেকে
...
অপেক্ষায় থাকা যন্ত্রের একটি আন্দাজ। এই ফ্ল্যাগের দাঁত আছে। `pybabel compile`
...
!!! bug "`--check` context ব্যবহার করা ক্যাটালগ গেট করতে পারে না"
    ...
    তুলনাটি চলে `Catalog.is_identical`-এর মধ্য দিয়ে, যে প্রতিটি বার্তা খোঁজে
    যে কী-তে সেটি সংরক্ষিত সেই কী দিয়ে — আর context-যুক্ত বার্তার ক্ষেত্রে
    সেই কী হল `(id, context)` জোড়া, যা `Catalog.get` গ্রহণই করে না। লুকআপ
    কিছুই ফেরায় না, আর ক্যাটালগ দুটি কখনও সমান হয় না:
    ...
    তাই আপনি `pgettext` বা `npgettext` আদৌ ব্যবহার করলে — আর সমোচ্চারিত শব্দের
    অস্পষ্টতা কাটানোই তো তাদের থাকার কারণ — এই ধাপটি সবচেয়ে খারাপভাবে
    ব্যর্থ হয়: সবসময় লাল, তাই দল সেটি বন্ধ করে দেয়, তাই পুরনো হয়ে যাওয়াকে
    কিছুই আর গেট করে না। যতদিন না এটি upstream-এ সারানো হয়, বার্তার সেটগুলি
    নিজেই মিলিয়ে দেখুন। `babel.messages.pofile.read_po` দিয়ে টেমপ্লেট আর
    প্রতিটি ক্যাটালগ পড়ে `{(m.context, m.id) for m in catalog if m.id}` তুলনা
    করাই গোটা যাচাই, আর [এই সাইটের নিজের বিল্ড](index.md) সেটাই করে।
