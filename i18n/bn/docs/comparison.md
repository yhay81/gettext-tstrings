---
description: "একই অনুবাদযোগ্য বার্তা %-format, .format(), flufl.i18n $-strings ও t-string দিয়ে লেখা, সঙ্গে প্রতিটি কীভাবে মান বাঁধে আর ভাঙা ক্যাটালগ সামলায়।"
---

# t-strings কেন

একটি অনুবাদযোগ্য বার্তায় মান বসানোর চারটি উপায়, একই বাক্যের উপর তুলনা করে
দেখা। সংক্ষেপে:

- **%-format**-এ কোনও অনুবাদক একটি অক্ষর মুছে ফেললেই তা প্রোডাকশনে ক্র্যাশ
  হয়ে দাঁড়ায়।
- **str.format**-এ একটি অনুবাদ আপনার কোড যেসব অবজেক্ট পাঠায় তাদের অ্যাট্রিবিউট
  পড়ে ফেলতে পারে — গোপন তথ্যসহ।
- **$-strings** (flufl.i18n)-এ মানগুলি নীরবে কলিং ফাংশনের ভেরিয়েবল থেকে
  টেনে আনা হয়, আর ডট-যুক্ত placeholder অ্যাট্রিবিউট পর্যন্তও পৌঁছয়।
- **t-strings**-এ ফরম্যাটিং আপনার কোডেই থাকে, অনুবাদ রানটাইমে যাচাই হয়, আর
  ভাঙা ক্যাটালগ ক্র্যাশ না করে উৎস টেক্সটে ফলব্যাক করে।

এই পৃষ্ঠার বাকিটা তার প্রমাণ, একবারে একটি পদ্ধতি।
...
PO এডিটরে এক অক্ষরের সম্পাদনা প্রোডাকশনে ট্রেসব্যাক হয়ে দাঁড়ায়। GNU
`msgfmt --check-format` এটি ধরে বটে, কিন্তু কেবল `python-format` ফ্ল্যাগ পাওয়া
...
উৎস টেক্সট রেন্ডার করে, তাই খারাপ ক্যাটালগ কখনও অ্যাপ্লিকেশনকে ফেলে দেয় না —
...
অনুবাদককে তার দিকে তাকাতেও হয় না।
...
| --- | --- | --- | --- | --- |
| placeholder কি নাম-যুক্ত? | হ্যাঁ | হ্যাঁ | হ্যাঁ | হ্যাঁ |
| অনুবাদক কি placeholder পুনর্বিন্যাস করতে পারেন? | হ্যাঁ | হ্যাঁ | হ্যাঁ | হ্যাঁ |
...
| অনুবাদ একটি placeholder *বাদ দিলে* — কী রেন্ডার হয়? | মানটি নীরবে উধাও হয় | মানটি নীরবে উধাও হয় | মানটি নীরবে উধাও হয় | উৎস টেক্সট, একটি সতর্কবার্তাসহ ([ডিফল্টে](guide.md#what-happens-when-a-catalog-is-wrong)) |
| অনুবাদ একটি অজানা placeholder *যোগ করলে* — কী রেন্ডার হয়? | একটি এক্সেপশন | একটি এক্সেপশন | placeholder-টি টেক্সট হিসেবে দৃশ্যমান থাকে | উৎস টেক্সট, একটি সতর্কবার্তাসহ ([ডিফল্টে](guide.md#what-happens-when-a-catalog-is-wrong)) |
...
স্থির টেক্সট আর মানগুলিকে আলাদা রাখে। `$`-strings আগে থেকেই একটি সংক্ষিপ্ত
বিকল্প দেয়, ভিন্ন বাঁধাই ও ভিন্ন ব্যর্থতা-মডেলসহ। `flufl.i18n` একটি পরিণত
প্যাকেজ যা Python 3.10 ও তার পরে চলে; `gettext-tstrings` এখন একটি alpha, আর
t-strings নতুন সিনট্যাক্স হওয়ায় তার Python 3.14 বা নতুনতর দরকার।

অন্য দামটি হল সীমাবদ্ধতাটি নিজেই: একটি ইন্টারপোলেশনকে সরল নাম হতেই হবে।
...
এটি সত্যিকারের একটি বাধা। উৎস-দিকের মান-বাঁধাই ও রানটাইমে placeholder
যাচাইয়ের সঙ্গে মিলে এটি ক্যাটালগ স্ট্রিংকে এক্সপ্রেশন মূল্যায়ন করা থেকে
আটকায় আর placeholder নামগুলিকে অর্থবহ রাখে।
