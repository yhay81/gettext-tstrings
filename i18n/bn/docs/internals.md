...
??? example "সেই সংস্করণগুলির নয়টি, রূপের ক্রমে"
...
অনুবাদকদের জন্য লেখা
[ব্যর্থতা-পড়ার টেবিল](translators.md#reading-a-failure-message) এদের প্রতিটি
বার্তা হুবহু দেখায়।
...
দিয়ে arm64 ল্যাপটপে macOS 26-এর উপর CPython 3.14.6-এ মাপা ফল: একটি এক-ফিল্ড
বার্তায় t-string নিজে তৈরি করা ধরে মোটামুটি 0.4 µs, অর্থাৎ কিছুই যাচাই করে
না এমন একটি সাদামাটা `gettext(...).format(...)`-এর প্রায় ২.৭ গুণ। এগুলি একটিমাত্র
মেশিনের সংখ্যা — স্ক্রিপ্টটি তার হেডারে নিজের ইন্টারপ্রেটার ও প্ল্যাটফর্ম ছাপে,
তাই কোনও অনুপাতকে নিজের বলে ধরে নেওয়ার আগে আপনি সত্যিই যে হার্ডওয়্যারে ডিপ্লয়
করেন তার উপরেই সেটি চালান।
...
উপরের কিছুই কেবল এই বাস্তবায়নেরই নিজস্ব নয়: রীতিটি লিখিত আছে [spec v1](spec.md) হিসেবে, আর
