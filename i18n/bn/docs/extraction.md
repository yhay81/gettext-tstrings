...
## ডিফল্টেই মজবুত { #robust-by-default }

একটি খারাপ ফাইল গোটা রানটাকে শেষ করে দেয় না:
...
ম্যাপিং অপশনে `strict = true` দিলে এদের প্রতিটিই কড়া ব্যর্থতায় পরিণত হয়, যা
CI-তে আপনি ঠিক এটাই চান।
...
বাঁধা। তাদের আচরণ তাদেরই; নিচের দুটি টুল সেগুলিই যা এখানে যাচাই করা হয়েছে।
...
দুটি যাচাই অপ্রয়োজনীয় পুনরাবৃত্তি নয়। সঙ্গে দেওয়া চেকার অন্তত দুই জায়গায়
বেশি কড়া:
