...
[开始五分钟教程 :material-arrow-right:](tutorial.md){ .md-button .md-button--primary }
...
本库在入口处检查这一点——目录编译的时候——渲染时再检查一次；这正是“在评审中发现
的错误”与“被用户发现的错误”之间的区别。
...
| [规范](spec.md) | v1，附带[一致性测试套件](spec.md#conformance) |
...
| 变更 | [CHANGELOG](https://github.com/yhay81/gettext-tstrings/blob/main/CHANGELOG.md) |
