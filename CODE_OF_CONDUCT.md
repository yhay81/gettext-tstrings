...
and this Code reinforces encouraged behaviors and norms that can help avoid
conflicts and minimize harm.

Report a possible violation privately to the project maintainer at
<yusuke8h@gmail.com>. Do not report conduct incidents in a public Issue or
Discussion. Include relevant links or records and any immediate safety or
confidentiality concerns.

The maintainer acts as the current Community Moderator and takes reports
seriously. Reports will be investigated by reviewing relevant messages, logs,
or other records and, when appropriate, speaking with involved people. Reports
and enforcement actions will be kept as private as possible while prioritizing
safety and fairness.

## Addressing and repairing harm

If an investigation finds that this Code of Conduct has been violated, the
following enforcement ladder may be used. A step may be skipped when the impact
or urgency calls for a stronger response.

1. **Warning**
   - **Event:** A violation involving a single incident or series of incidents.
   - **Consequence:** A private, written warning.
   - **Repair:** Acknowledging responsibility, seeking clarification, or making
     a private written apology when appropriate.
2. **Temporarily limited activities**
   - **Event:** A repeated violation after a warning, or a more serious first
     violation.
   - **Consequence:** A written warning and a time-limited cooldown restricting
     particular channels or interactions.
   - **Repair:** Respecting the cooldown, reflecting on the impact, and
     re-entering community spaces thoughtfully.
3. **Temporary suspension**
   - **Event:** Repeated violations that prior steps did not resolve, or a
     single serious violation.
   - **Consequence:** Temporary removal from community spaces, with conditions
     for return.
   - **Repair:** Meeting the stated conditions and reintegrating thoughtfully.
4. **Permanent ban**
   - **Event:** A pattern of serious violations that other steps failed to
     resolve, or a violation so severe that continued participation cannot be
     made safe.
   - **Consequence:** Permanent removal from community spaces and channels.
   - **Repair:** There is no return in cases of this severity.

This ladder is a guideline and does not prevent the moderator from using their
judgment in the best interests of the community and affected people.
...
social account, or acting as an appointed representative at an event.
...
licensed under
[CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/). Its enforcement
